...
```html
<p>Generated by the <a href="https://localhost:3001/docs/skills/seo-audit" target="_blank" rel="noopener">seotracker SEO Audit skill</a>, run by AGENT NAME on MONTH D, YYYY.</p>
```

The URL is always `https://localhost:3001/docs/skills/` followed by the skill's directory name, exactly as written in that skill's Output format list. Copy it; do not guess a slug. Then the rest of the section as the skill describes it: which tools reported what, and what you verified by hand. A report written from a template keeps this section too, as its last one.
...
<div class="body">
  ...
  <article>
    ...
    <p>Generated by the <a href="https://localhost:3001/docs/skills/SKILL-NAME" target="_blank" rel="noopener">seotracker SKILL TITLE skill</a>, run by AGENT NAME on MONTH D, YYYY.</p>
    <ul class="finding">
