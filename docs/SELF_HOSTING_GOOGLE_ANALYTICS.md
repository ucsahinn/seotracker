...
Connecting Google Analytics lets seotracker bind a GA4 property to a project. The
...
| ------------ | ----------------------------------------------------------- |
| Deployed     | `https://your-seotracker-domain.com/api/ga4/oauth/callback` |
...
seotracker stores the OAuth tokens encrypted in Better Auth's account table. The
